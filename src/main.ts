...
const components: any[] = [Button, Input, Textarea, Icon, Tag, Dropdown, CopyLink, Switch];
...
export { install, Button, Input, Textarea, Icon, Tag, Notify, Dropdown, CopyLink, Switch };
