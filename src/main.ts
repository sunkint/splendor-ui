...
const components: any[] = [Button, Input, Textarea, Icon, Tag, Dropdown, CopyLink, Loading];
...
export { install, Button, Input, Textarea, Icon, Tag, Notify, Dropdown, CopyLink, Loading };
